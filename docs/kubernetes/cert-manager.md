...
Edit [`cluster-issuer.yaml`](https://github.com/mevijays/goca/blob/main/k8s-demo/cluster-issuer.yaml): replace `CA_BASE_URL`
...
**[csi.md](csi.md)** instead: it walks through goca's
