...
[`csidriver.yaml`](https://github.com/mevijays/goca/blob/main/k8s-demo/csi/csidriver.yaml) for why this is a patch, not a separate
object:
...
Edit [`provider-daemonset.yaml`](https://github.com/mevijays/goca/blob/main/k8s-demo/csi/provider-daemonset.yaml): replace
...
Edit [`secretproviderclass.yaml`](https://github.com/mevijays/goca/blob/main/k8s-demo/csi/secretproviderclass.yaml) if you changed
...
See [cert-manager.md](cert-manager.md) for the cert-manager/ACME demo this
