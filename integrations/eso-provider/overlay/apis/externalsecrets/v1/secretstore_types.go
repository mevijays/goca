...
type SecretStoreProvider struct {
	...
	// Goca configures this store to sync secrets using goca
	// (https://github.com/mevijays/goca), authenticating with a
	// TokenRequest-minted Kubernetes ServiceAccount token.
	// +optional
	Goca *GocaProvider `json:"goca,omitempty"`
