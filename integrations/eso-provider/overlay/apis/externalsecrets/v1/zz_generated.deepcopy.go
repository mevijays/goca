...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GocaProvider) DeepCopyInto(out *GocaProvider) {
	*out = *in
	in.ServiceAccountRef.DeepCopyInto(&out.ServiceAccountRef)
	if in.CABundle != nil {
		in, out := &in.CABundle, &out.CABundle
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GocaProvider.
func (in *GocaProvider) DeepCopy() *GocaProvider {
	if in == nil {
		return nil
	}
	out := new(GocaProvider)
	in.DeepCopyInto(out)
	return out
}
